...
class MainMenuState extends MusicBeatState
{
	...
	public static var nightly:String = " Custom Build Fake >:)";
	...
	override function create()
	{
		...
		var bg:FlxSprite = new FlxSprite(-100).loadGraphic(Paths.image('menuBlue'));
		bg.scrollFactor.x = 0;
		...
		magenta = new FlxSprite(-80).loadGraphic(Paths.image('menuRed'));
