			...
			case 'stageair':
				{
						defaultCamZoom = 0.9;
						curStage = 'stageair';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('susstage/BG1'));
						bg.antialiasing = true;
				...
				case 'stagedie':
				{
						defaultCamZoom = 0.9;
						curStage = 'stagedie';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('susstage/BG2'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);
					...
					if (!daNote.mustPress && daNote.wasGoodHit)
					{
						...
						switch (Math.abs(daNote.noteData))
						{
							case 2:
								...
								if(SONG.player2 == 'g_bluefinal'){
									FlxG.camera.shake(0.07, 0.07);
								}
							case 3:
		...
		else
		{
			if (isStoryMode)
			{
				...
				else
				{
					...
					switch(SONG.song.toLowerCase()) //ADD CUTCENES BY Nong vanila ล.ช.
				    {
						case 'die to rip':
							FlxG.switchState(new VideoState('assets/videos/cut2.webm', new PlayState()));
						case 'die':
							FlxG.switchState(new VideoState('assets/videos/cut3.webm', new PlayState()));
					    default:
